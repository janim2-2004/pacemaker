...
class Mode:
    ...
    def aaiInterface(self):
        ...
        atrialThresLabel = ttk.Label(self.tab3, text="Atrial Sensitivity:").grid(column=1, row=5, padx=20, pady=10, sticky="e")
        atrialThresValue = ttk.Label(self.tab3, text=self.atrialThres.get()).grid(column=2, row=5, padx=20, pady=10)
        atrialThresUnit = ttk.Label(self.tab3, text="V").grid(column=3, row=5, padx=20, pady=10, sticky="w")
    ...
    def __aaiInterfaceConfig(self):
        ...
        self.atrialThresInput3 = ttk.Entry(self.tab3, textvariable=self.atrialThres, justify=CENTER)
        self.atrialThresInput3.grid(column=2, row=5, padx=20, pady=10)
        self.atrialThresInput3.config(validate="key", validatecommand=(reg, "%P"))
    ...
    def __aaiConfigConfirm(self):
        ...
        if (self.atrialThres.get() < 0) or (self.atrialThres.get() > 5.0):
            invalid = True
    ...
    def vviInterface(self):
        ...
        ventriThresLabel = ttk.Label(self.tab4, text="Ventri. Sensitivity:").grid(column=1, row=5, padx=20, pady=10, sticky="e")
        ventriThresValue = ttk.Label(self.tab4, text=self.ventriThres.get()).grid(column=2, row=5, padx=20, pady=10)
        ventriThresUnit = ttk.Label(self.tab4, text="V").grid(column=3, row=5, padx=20, pady=10, sticky="w")
    ...
    def __vviInterfaceConfig(self):
        ...
        self.ventriThresInput4 = ttk.Entry(self.tab4, textvariable=self.ventriThres, justify=CENTER)
        self.ventriThresInput4.grid(column=2, row=5, padx=20, pady=10)
        self.ventriThresInput4.config(validate="key", validatecommand=(reg, "%P"))
